...
{
    [Table("Files")]
    public class SecureFileEntity(string path) : CoreEntity
    {
        public string Path { get; set; } = path;

        public ZFile.FileType FileType { get; set; }

        public SecureFileItem.CensorType CensorType { get; set; }
    ...
    {
        public DbSet<SecureFileEntity> Files { get; private set; }
