...
namespace IOApp.Pages
{
    internal partial class Installer : MainWindowPage
    {
        ...
        void Login()
        {
            try
            {
                PasswordException.ThrowIfNullOrWhiteSpace(PasswordBox.Password);
                PasswordException.ThrowIfNotCorrect(PasswordBox.Password, AppLocalStorage.Password);
