...
namespace IOApp.Pages
{
    internal partial class ViewerPage : MainWindowPage, IDisposable
    {
        ...
        public static void Open(WindowEx window, ViewerItem item, IEnumerable<ViewerItem> items)
        {
            ...
            if (items.Any(i => i == item))
                if (window.Navigate(typeof(ImageViewer), null) is ViewerPage page)
                {
    ...
    {
        ViewerPackageStorage() { }

        public bool IsListVisible
        {
            get => GetValueOrDefault(Name(), true, null);
        ...
        {
            get => GetValueOrDefault(Name(), DefaultCensorBlurAmount, null);
            set => Set(Name(), value, null);
        }

        public Color CensorColor
        {
            get => GetValueOrDefault(Name(), DefaultCensorColor, null);
            set => Set(Name(), value, null);
        }

        public double ViewRadius
        {
            get => GetValueOrDefault(Name(), DefaultViewRadius, null);
            set => Set(Name(), value, null);
        }
    }
}