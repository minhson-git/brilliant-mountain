...
namespace IOApp.Pages
{
    internal partial class PlayerPage : MainWindowPage, IDisposable
    {
        ...
        public PlayerPage()
        {
            ...
            {
                if (PlayerEx.SleepDelay is not (PlayerEx.SleepDelayKind.Off or PlayerEx.SleepDelayKind.Ended))
                {
        ...
        protected void BuildMenuFlyouts()
        {
            ...
            PlayerEx.SPEEDS.ForEach(i =>
            {
                ...
                var isEnabled = Window.License.Status.IsPremium || i.Key is PlayerEx.SpeedKind._0_5 or PlayerEx.SpeedKind._0_75 or PlayerEx.SpeedKind._1 or PlayerEx.SpeedKind._1_25 or PlayerEx.SpeedKind._1_5;
        ...
        public static void Open(WindowEx window, PlayerItem item, IEnumerable<PlayerItem> items, Type type)
        {
            ...
            if (items.Any(i => i == item))
                if (window.Navigate(type, null) is PlayerPage page)
                {
    ...
    {
        PlayerPackageStorage() { }

        public bool Mute
        {
            get => GetValueOrDefault(Name(), false, null);
